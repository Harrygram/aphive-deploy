...
import FollowButton from "@/components/subreddit/FollowButton";
...
async function CommunityPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <>
      {/* Header Section */}
      <section className="bg-white dark:bg-black border-b dark:border-gray-700">
          ...
          <div className="flex flex-col md:flex-row justify-between gap-6">
            ...
            {user?.id && (
              <div className="pt-2 px-9">
                <FollowButton communityId={community.id} userId={user.id} />
              </div>
            )}
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="flex flex-col gap-4">
            {posts.length > 0 ? (
              ...
              <div className="bg-white dark:bg-black rounded-md p-6 text-center">
